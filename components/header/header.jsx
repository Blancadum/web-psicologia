  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        {/* Menú hamburguesa */}
        <button
          className="text-2xl md:hidden focus:outline-none text-brandPurple"
          onClick={toggleMenu}
        ...
        <nav
          className={`
            fixed top-0 left-0 h-full bg-white shadow-lg transform transition-transform duration-300 ease-in-out
            w-2/3 p-6 flex flex-col gap-4
            ${isOpen ? "translate-x-0" : "-translate-x-full"}
            md:static md:translate-x-0 md:flex-row md:w-auto md:p-0 md:shadow-none
          `}
        >
          <ul className="flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-8">
            ...
            <li>
              <Link href="/faq" className="text-lg text-gray-700 hover:text-brandPink transition-colors">
                Preguntas
              </Link>
            </li>
            <li>
